...
module dinorun(clk_25_175_i, rst_ni, start_i, up_i, down_i, digit0_en_o, digit0_o, digit1_en_o, digit1_o, digit2_en_o, digit2_o, digit3_en_o, digit3_o, vga_red_o, vga_green_o, vga_blue_o, vga_hsync_o, vga_vsync_o);
  ...
  \$reduce_or  #(
    ...
    .A({ _26_, drawing_bird, drawing_dino }),
    .Y(_17_)
  );
  \$reduce_or  #(
    .A_SIGNED(32'd0),
  ...
  \$reduce_or  #(
    ...
    .A({ _26_, drawing_bird, drawing_cactus, drawing_dino }),
    .Y(_19_)
  );
  \$reduce_or  #(
    .A_SIGNED(32'd0),
...
module vga_timer(clk_i, rst_ni, hsync_o, vsync_o, visible_o, position_x_o, position_y_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [8:0] \sv2v_cast_5F333$func$synth/yosys_common/build/rtl.sv2v.v:413$215.inp ;
  wire [9:0] \sv2v_cast_60BAD$func$synth/yosys_common/build/rtl.sv2v.v:408$214.inp ;
  output visible_o;
  wire visible_o;
  output vsync_o;
  wire vsync_o;
  ...
  assign \sv2v_cast_5F333$func$synth/yosys_common/build/rtl.sv2v.v:413$215.inp  = 9'hxxx;
  assign \sv2v_cast_60BAD$func$synth/yosys_common/build/rtl.sv2v.v:408$214.inp  = 10'hxxx;
endmodule
