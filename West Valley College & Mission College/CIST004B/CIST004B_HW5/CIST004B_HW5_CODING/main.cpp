...
#include "sequence3.hpp"  // Provides the sequence class with double items.
using namespace std;
...
cout << "Inserting 10, which should go at the sequence's front." <<
endl;
...
cout << "Copy constructor test: for a sequence with cursor at front."
<< endl;
original.insert(2);
original.start( );
